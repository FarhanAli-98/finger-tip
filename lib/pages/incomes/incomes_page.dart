                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  ...
                                  style: customStyle(Colors.grey[200], 11, FontWeight.normal)
                                ),
                              ),
                              SizedBox(width: 10,),
                                Text(
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Text(
                                        ...
                                        overflow: TextOverflow.ellipsis,
                                        maxLines: 1,
                                        style: customStyle(budget.color == null ? selectedColor : Color( int.parse(budget.color)), 18, FontWeight.bold)
                                      ),
