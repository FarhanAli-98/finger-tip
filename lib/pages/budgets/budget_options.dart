...
class _BudgetOptPageState extends State<BudgetOptPage> {
  ...
  void deleteExpenses() async {
    final QuerySnapshot snap = await FirebaseFirestore.instance
        ...
        .where('budgetTimestamp', isEqualTo: budget.timestamp)
        .get();
    List<Expense> expenses =
        snap.docs.map((data) => Expense.fromMap(data.data())).toList();
  ...
  void deleteIncomes() async {
    final QuerySnapshot snap = await FirebaseFirestore.instance
        ...
        .get();
    List<Income> incomes =
        snap.docs.map((data) => Income.fromMap(data.data())).toList();
