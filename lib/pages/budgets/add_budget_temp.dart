...
class _AddTempBudgetPageState extends State<AddTempBudgetPage> {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('temp_budget'.tr(),
              style: customStyleLetterSpace(
                  Colors.white, 18, FontWeight.w700, 0.338)),
          centerTitle: true,
          actions: <Widget>[
            IconButton(
              icon: Icon(
                      ...
                      child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: customStyle(
                                Colors.grey[400], 16, FontWeight.normal),
                          ...
                          validator: (value) {
                            if (value.isEmpty) return 'empty_value'.tr();
                            return null;
                          },
                          ...
                          style:
                              customStyle(Colors.white, 16, FontWeight.normal)),
                    ),
                    Container(
                      padding: EdgeInsets.only(left: 20, right: 20),
                      child: TextFormField(
                        maxLength: 7,
                        initialValue: budget.initialIncome == null
                            ? ''
                            : budget.initialIncome.toString(),
                        onChanged: (value) {
                          setState(() {
  ...
  Future<Null> _selectEndDate(BuildContext context) async {
    final DateTime picked = await showDatePicker(
        context: context,
        initialDate:
            _selectedEndDate == null ? DateTime.now() : _selectedEndDate,
        firstDate: DateTime(2020),
        lastDate: DateTime(2022));
